  ...
  return (
    <div style={{ fontFamily: "Inter, sans-serif", background: "#F5F7F8", minHeight: 600, color: "#1E2A30" }}>
      ...
      {!currentUser ? (
        ...
        <DoctorDashboard user={currentUser} patients={patients} consultations={consultations} setConsultations={persistConsultations} onLogout={handleLogout} />
      ) : (
...
function DoctorDashboard({ user, patients, consultations, setConsultations, onLogout }) {
  const [query, setQuery] = useState("");
